...
<head>
    <title>Code coverage report for test/test_util.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">test</a> test_util.ts</h1>
        <div class='clearfix'>
...
<a name='L136'></a><a href='#L136'>136</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">74x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BufferedDebugHandler } from "../src/debugging";
...
<span class="cstat-no" title="statement not covered" >        debugHandler.executeBufferedBlocks();</span>
<span class="cstat-no" title="statement not covered" >        e.stack = e.stack.replace(/[^\n]*at .*test_util.*\n/g, "");</span>
...
expect.extend({
    toBeDate(resultOrComponent, date) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof resultOrComponent.date !== "function") {
<span class="cstat-no" title="statement not covered" >            return {</span>
                message: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >`${resultOrComponent} is not a ParsedResult or ParsedComponent`,</span>
                pass: false,
            };
        }
&nbsp;
        ...
        return {
            message: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >`Expected date to be: ${date} Received: ${actualDate} (${resultOrComponent})`,</span>
...
&nbsp;
    toBeSingleOnText(results, text) {
        if (results.length === 1) {
            return {
                message: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >`Got single result from '${text}'`,</span>
                pass: true,
            };
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return {</span>
            message: <span class="fstat-no" title="function not covered" >() =</span>&gt;
<span class="cstat-no" title="statement not covered" >                `Got ${results.length} results from '${text}'\n${results</span>
                    .map(<span class="fstat-no" title="function not covered" >(r</span>esult) =&gt; <span class="cstat-no" title="statement not covered" >JSON.stringify(result))</span>
                    .join("\n")}`,
            pass: false,
        };
    },

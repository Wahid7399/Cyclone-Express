...
<head>
    <title>Code coverage report for src/common/parsers/AbstractTimeExpressionParser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/common/parsers</a> AbstractTimeExpressionParser.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">91% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>182/200</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Parser, ParsingContext } from "../../chrono";
...
&nbsp;
        ...
        if (match[MILLI_SECOND_GROUP] != null) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (millisecond &gt;= 1000) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
...
&nbsp;
        // ----- Millisecond
        <span class="missing-if-branch" title="if path not taken" >I</span>if (match[MILLI_SECOND_GROUP] != null) {
            const millisecond = <span class="cstat-no" title="statement not covered" >parseInt(match[MILLI_SECOND_GROUP].substring(0, 3));</span>
<span class="cstat-no" title="statement not covered" >            <span class="missing-if-branch" title="if path not taken" >I</span>if (millisecond &gt;= 1000) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            components.assign("millisecond", millisecond);</span>
        }
&nbsp;
        // ----- Second
        if (match[SECOND_GROUP] != null) {
...
&nbsp;
            ...
            if (ampm == "a") {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (hour == 12) {
<span class="cstat-no" title="statement not covered" >                    hour = 0;</span>
<span class="cstat-no" title="statement not covered" >                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!components.isCertain("day")) {</span>
<span class="cstat-no" title="statement not covered" >                        components.imply("day", components.get("day") + 1);</span>
                    }
                }
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                components.imply("meridiem", Meridiem.PM);</span>
            } else if (hour &lt;= 12) {
                components.imply("meridiem", Meridiem.AM);
            }
        }
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (endingNumbers.includes(".") &amp;&amp; !endingNumbers.match(/\d(\.\d{2})+$/)) {
<span class="cstat-no" title="statement not covered" >                return null;</span>
            }
&nbsp;
...
&nbsp;
            // If it ends only with numbers above 24, e.g. "at 25"
            const endingNumberVal = <span class="cstat-no" title="statement not covered" >parseInt(endingNumbers);</span>
            const startingNumberVal = <span class="cstat-no" title="statement not covered" >parseInt(startingNumbers);</span>
<span class="cstat-no" title="statement not covered" >            <span class="missing-if-branch" title="if path not taken" >I</span>if (endingNumberVal &gt; 24 || startingNumberVal &gt; 24) {</span>
<span class="cstat-no" title="statement not covered" >                return null;</span>
            }
        }
&nbsp;

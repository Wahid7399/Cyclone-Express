...
<head>
    <title>Code coverage report for src/chrono.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> chrono.ts</h1>
        <div class='clearfix'>
...
<a name='L189'></a><a href='#L189'>189</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">76x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1319x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1319x</span>
<span class="cline-any cline-yes">1319x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1319x</span>
<span class="cline-any cline-yes">12128x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1319x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">17358x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3722x</span>
<span class="cline-any cline-yes">3722x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3722x</span>
<span class="cline-any cline-yes">3722x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3238x</span>
...
<span class="cline-any cline-yes">2765x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ReferenceWithTimezone, ParsingComponents, ParsingResult } from "./results";
...
&nbsp;
    ...
    parseDate(text: string, referenceDate?: ParsingReference | Date, option?: ParsingOption): Date | null {
        ...
        return results.length &gt; 0 ? results[0].start.date() : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    }
&nbsp;
...
&nbsp;
            context.debug(<span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >console.log(`${parser.constructor.name} extracted result ${parsedResult}`))</span>;
&nbsp;
...
&nbsp;
        ...
        const end = endComponents ? <span class="branch-0 cbranch-no" title="branch not covered" >this.createParsingComponents(endComponents) </span>: null;
&nbsp;
...
&nbsp;
    debug(block: AsyncDebugBlock): void {
        if (this.option.debug) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.option.debug instanceof Function) {
<span class="cstat-no" title="statement not covered" >                this.option.debug(block);</span>
            } else {

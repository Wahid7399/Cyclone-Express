...
<head>
    <title>Code coverage report for src/locales/ru/parsers/RUWeekdayParser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/locales/ru/parsers</a> RUWeekdayParser.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        if (modifierWord == "прошлый" || modifierWord == "прошлую" || modifierWord == "прошлой") {
            ...
            modifier = "next";
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (modifierWord == "этот" || modifierWord == "эту" || modifierWord == "этой") {

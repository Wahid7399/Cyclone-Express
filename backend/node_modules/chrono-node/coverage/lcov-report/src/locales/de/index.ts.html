...
<head>
    <title>Code coverage report for src/locales/de/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/locales/de</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L52'></a><a href='#L52'>52</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">76x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { includeCommonConfiguration } from "../../configurations";
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >parseDate(</span>text: string, ref?: Date, option?: ParsingOption): Date {
<span class="cstat-no" title="statement not covered" >    return casual.parseDate(text, ref, option);</span>
}
&nbsp;
...
&nbsp;
export function createConfiguration(strictMode = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span> littleEndian = true): Configuration {

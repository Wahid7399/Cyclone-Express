...
<head>
    <title>Code coverage report for src/locales/fr/constants.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/locales/fr</a> constants.ts</h1>
        <div class='clearfix'>
...
export function parseNumberPattern(match: string): number {
    ...
    if (INTEGER_WORD_DICTIONARY[num] !== undefined) {
        ...
        return 3;
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (num.match(/demi-?/)) {

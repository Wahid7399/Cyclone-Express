...
<head>
    <title>Code coverage report for src/calculation/mergingCalculation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/calculation</a> mergingCalculation.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">199x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ParsingComponents, ParsingResult } from "../results";
...
<span class="cstat-no" title="statement not covered" >                endDateTime.imply("day", endDateTime.get("day") + 1);</span>
            }
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            dateTimeComponent.imply("hour", dateTimeComponent.get("hour") + 12);</span>
        }
    }
&nbsp;

...
<head>
    <title>Code coverage report for src/common/refiners/MergeWeekdayComponentRefiner.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/common/refiners</a> MergeWeekdayComponentRefiner.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (newResult.end) {
<span class="cstat-no" title="statement not covered" >            newResult.end.assign("weekday", currentResult.start.get("weekday"));</span>
        }
&nbsp;
        return newResult;
    }

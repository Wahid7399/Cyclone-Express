...
<head>
    <title>Code coverage report for src/locales/de/parsers/DECasualDateParser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/locales/de/parsers</a> DECasualDateParser.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    innerExtract(context: ParsingContext, match: RegExpMatchArray): ParsingComponents | ParsingResult {
        ...
        const dateKeyword = (match[DATE_GROUP] || <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>.toLowerCase();
...
&nbsp;
            case "morgen":
                ...
                break;
&nbsp;
<span class="branch-3 cbranch-no" title="branch not covered" >            case "übermorgen":</span>
            case "uebermorgen":

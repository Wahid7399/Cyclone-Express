...
<head>
    <title>Code coverage report for src/common/refiners/ExtractTimezoneAbbrRefiner.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/common/refiners</a> ExtractTimezoneAbbrRefiner.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1301x</span>
<span class="cline-any cline-yes">1526x</span>
<span class="cline-any cline-yes">1526x</span>
<span class="cline-any cline-yes">1526x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Map ABBR -&gt; Offset in minute
...
&nbsp;
    refine(context: ParsingContext, results: ParsingResult[]): ParsingResult[] {
        const timezoneOverrides = context.option.timezones<span class="branch-0 cbranch-no" title="branch not covered" > ?? {</span>};
&nbsp;
...
&nbsp;
            ...
            const extractedTimezoneOffset = timezoneOverrides[timezoneAbbr]<span class="branch-0 cbranch-no" title="branch not covered" > ?? t</span>his.timezone[timezoneAbbr] ?? null;
...
<span class="cstat-no" title="statement not covered" >                result.end.assign("timezoneOffset", extractedTimezoneOffset);</span>
            }
        });
&nbsp;
        return results;

...
<head>
    <title>Code coverage report for src/locales/en/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/locales/en</a> index.ts</h1>
        <div class='clearfix'>
 ...
 */
export function createConfiguration(strictMode = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span> littleEndian = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: Configuration {
